...
class DecisionTree:
    ...
    def fit(self, X, y):
        ...
        self.create_tree(X_train, y_train)
    ...
    def create_tree(self, X, y):
        ...
        if 0 in y_val:
            ...
            neg_val = 0
        self.major_class = 1 if neg_val > len(y) - neg_val else 0
        ...
        self.left.create_tree(left_X, left_y)
        self.right = DecisionTree()
        self.right.create_tree(right_X, right_y)
    ...
    def predict_row(self, x):
        ...
        elif x.iloc[0][self.split_feature] == 0:
...
if __name__ == "__main__":
    ...
    print(tree.predict_array(example_data))
